...
<!-- Background -->
<script src="<%=request.getContextPath()%>/bower_components/login/jquery.backstretch.min.js"></script>
<script src="<%=request.getContextPath()%>/bower_components/login/scripts.js"></script>
